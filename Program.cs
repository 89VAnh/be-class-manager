...
builder.Services.AddTransient<ILectureBusiness, LectureBusiness>();
...
builder.Services.AddTransient<IDepartmentBussiness, DepartmentBusiness>();
builder.Services.AddTransient<Excel, Excel>();
